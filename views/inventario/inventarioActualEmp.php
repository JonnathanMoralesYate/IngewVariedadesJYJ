        ...
        <div class="col-lg-4 col-md-6 col-sm-8 col-10">
            <div class="d-flex justify-content-center">
                <a class="btn btn-outline-secondary text-white mt-3 w-50 text-center"
                    href="index.php?action=reporteInventarioPDF"
                    target="_blank">
                    Generar PDF
                </a>
            </div>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-8 col-md-10 col-sm-12">
            ...
            <!-- Buscar por Nombre -->
            <form class="mt-3" action="index.php?action=consultaProductosNombreInventarioEmp" method="get">
                <input type="hidden" name="action" value="consultaProductosNombreInventarioEmp">
    ...
    <div class="row">
        <div class="col-12 col-md-10 offset-md-1">
            <div class="text-center">
                <?php if (isset($data['inventario']) && count($data['inventario']) > 0): ?>
            ...
            <?php
                    ...
                    $param = "nombre=$filtro";
                    $action = 'consultaProductosNombreInventarioEmp';
