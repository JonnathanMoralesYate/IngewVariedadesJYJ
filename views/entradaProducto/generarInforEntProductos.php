...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-8 col-md-10 col-sm-12">
            ...
            <form class=" mt-5" id="formReporte" action="index.php?action=reporteEntProductoFecha" method="get">
                <input type="hidden" class="form-control" name="action" value="reporteEntProductoFecha">
                <div class=" mt-2">
