        ...
        <div class="row">
            <div class="col-12 col-md-10 offset-md-1">
                <div class="text-center">
                    <?php if (isset($data['undBases']) && count($data['undBases']) > 0): ?>
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-striped text-white text-center">
                        ...
                        <tbody class="">
                            <?php foreach ($data['undBases'] as $undBase): ?>
                                <tr>
                ...
                <?php
                        ...
                        $action = $tipo === 'codigo' ? 'consultaUndBaseId' : 'consultaUndBaseNombre';
                        $param = $tipo === 'codigo' ? "idUndBase=$filtro" : "nomUndBase=$filtro";
