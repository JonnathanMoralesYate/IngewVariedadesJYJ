...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-8 col-md-10 col-sm-12">
            ...
            <!-- Buscar por Nombre -->
            <form class="mt-3" action="index.php?action=consultaEntProductosNombre" method="get">
                <input type="hidden" name="action" value="consultaEntProductosNombre">
    ...
    <div class="row">
        <div class="col-12 col-md-10 offset-md-1">
            ...
            <?php
                    ...
                    $param = "nombre=$filtro";
                    $action = 'consultaEntProductosNombre';
