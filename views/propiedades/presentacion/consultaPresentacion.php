    ...
    <div class="row">
        <div class="col-12 col-md-10 offset-md-1">
            <div class="text-center">
                <?php if (isset($data['presentaciones']) && count($data['presentaciones']) > 0): ?>
            ...
            <div class="table-responsive">
                <table class="table table-hover text-white text-center">
                    ...
                    <tbody class="">
                        <?php foreach ($data['presentaciones'] as $presentacion): ?>
                            <tr>
            ...
            <?php
                    ...
                    $action = $tipo === 'codigo' ? 'consultaPresentacionId' : 'consultaPresentacionNombre';
                    $param = $tipo === 'codigo' ? "idPresentacion=$filtro" : "nomPresentacion=$filtro";
