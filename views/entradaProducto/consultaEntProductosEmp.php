...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-8 col-md-10 col-sm-12">
            ...
            <form class=" mt-4" action="index.php?action=consultaEntProductoCodigoEmp" method="get">
                <input type="hidden" class="form-control" name="action" value="consultaEntProductoCodigoEmp">
    ...
    <div class="row">
        <div class="col-12 col-md-10 offset-md-1">
            ...
            <?php
                    ...
                    $action = $tipo === 'codigo' ? 'consultaEntProductoCodigoEmp' : 'consultaEntProductoFechaEmp';
